...
> **Verdict: not_decodable** (protocol v0.1, config `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`, bundle `919cd7a11f601fcf80bde82b927acef37ac4cee6e271c43fd4daf3e304541a5b`)
>
...
- Probe AUROC: **0.495 [0.446, 0.541]** (leave-one-family-out, n=600, 7 families)
- Surface baseline `length`: AUROC 0.541; probe − baseline = -0.046 [-0.112, 0.023]
- Surface baseline `tfidf`: AUROC 0.445; probe − baseline = 0.049 [-0.012, 0.111]
...
- In-distribution, at a 5% false-alarm rate this probe flags about 2% of the cases it should (95% CI 1%–6%).
...
| --- | --- | --- |
| in_distribution | 1% | 0% [0%, 1%] |
| in_distribution | 5% | 2% [1%, 6%] |
| in_distribution | 10% | 7% [4%, 13%] |

AUROC by condition: in_distribution=0.495
...
- Protocol: v0.1; config hash `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`; bundle hash `919cd7a11f601fcf80bde82b927acef37ac4cee6e271c43fd4daf3e304541a5b`
- Re-run: `sieve audit --bundle runs/bundle.qwen15b-anchor.L7.mean_diff.json --seed 0`
