...
> **Verdict: not_decodable** (protocol v0.1, config `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`, bundle `82c00ce49708d7428beaba9b3fe6c40c48334c0803f3820d63641a9e32aa05d9`)
>
...
- Probe AUROC: **0.537 [0.491, 0.584]** (leave-one-family-out, n=600, 7 families)
- Surface baseline `length`: AUROC 0.507; probe − baseline = 0.030 [-0.037, 0.098]
- Surface baseline `tfidf`: AUROC 0.559; probe − baseline = -0.022 [-0.085, 0.040]
...
- In-distribution, at a 5% false-alarm rate this probe flags about 5% of the cases it should (95% CI 2%–12%).
...
| --- | --- | --- |
| in_distribution | 1% | 0% [0%, 3%] |
| in_distribution | 5% | 5% [2%, 12%] |
| in_distribution | 10% | 13% [8%, 17%] |

AUROC by condition: in_distribution=0.537
...
- Protocol: v0.1; config hash `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`; bundle hash `82c00ce49708d7428beaba9b3fe6c40c48334c0803f3820d63641a9e32aa05d9`
- Re-run: `sieve audit --bundle runs/bundle.qwen15b-base.L7.logistic_regression.json --seed 0`
