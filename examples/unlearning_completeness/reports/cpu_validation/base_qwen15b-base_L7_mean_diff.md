...
> **Verdict: not_decodable** (protocol v0.1, config `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`, bundle `4c6d5aa2d0d8826fe207c27833de0c47bb4b5bad1cf2a7f06d32b46353dc43c6`)
>
...
- Probe AUROC: **0.515 [0.472, 0.561]** (leave-one-family-out, n=600, 7 families)
- Surface baseline `length`: AUROC 0.507; probe − baseline = 0.008 [-0.051, 0.066]
- Surface baseline `tfidf`: AUROC 0.559; probe − baseline = -0.045 [-0.109, 0.013]
...
- In-distribution, at a 5% false-alarm rate this probe flags about 8% of the cases it should (95% CI 4%–13%).
...
| --- | --- | --- |
| in_distribution | 1% | 3% [0%, 5%] |
| in_distribution | 5% | 8% [4%, 13%] |
| in_distribution | 10% | 13% [9%, 18%] |

AUROC by condition: in_distribution=0.515
...
- Protocol: v0.1; config hash `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`; bundle hash `4c6d5aa2d0d8826fe207c27833de0c47bb4b5bad1cf2a7f06d32b46353dc43c6`
- Re-run: `sieve audit --bundle runs/bundle.qwen15b-base.L7.mean_diff.json --seed 0`
