...
> **Verdict: not_decodable** (protocol v0.1, config `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`, bundle `e3b30dbbdcff94947ac849174a069bb8f005c30c5b21695eadd884b4b401c8d2`)
>
...
- Probe AUROC: **0.465 [0.419, 0.513]** (leave-one-family-out, n=600, 7 families)
- Surface baseline `length`: AUROC 0.541; probe − baseline = -0.076 [-0.140, -0.011]
- Surface baseline `tfidf`: AUROC 0.445; probe − baseline = 0.019 [-0.044, 0.082]
...
- In-distribution, at a 5% false-alarm rate this probe flags about 3% of the cases it should (95% CI 1%–7%).
...
| in_distribution | 5% | 3% [1%, 7%] |
| in_distribution | 10% | 5% [3%, 10%] |

AUROC by condition: in_distribution=0.465
...
- Protocol: v0.1; config hash `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`; bundle hash `e3b30dbbdcff94947ac849174a069bb8f005c30c5b21695eadd884b4b401c8d2`
- Re-run: `sieve audit --bundle runs/bundle.qwen15b-anchor.L7.logistic_regression.json --seed 0`
