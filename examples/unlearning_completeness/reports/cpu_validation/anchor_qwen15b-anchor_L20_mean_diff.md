...
> **Verdict: not_decodable** (protocol v0.1, config `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`, bundle `f7b067ec7c6f3b3574d27dc7722e1fec86c4980773b39b83fe0f847b06b3f6cc`)
>
...
- Probe AUROC: **0.496 [0.449, 0.544]** (leave-one-family-out, n=600, 7 families)
- Surface baseline `length`: AUROC 0.541; probe − baseline = -0.044 [-0.107, 0.019]
- Surface baseline `tfidf`: AUROC 0.445; probe − baseline = 0.051 [-0.014, 0.113]
...
- In-distribution, at a 5% false-alarm rate this probe flags about 3% of the cases it should (95% CI 1%–6%).
...
| in_distribution | 5% | 3% [1%, 6%] |
| in_distribution | 10% | 7% [2%, 12%] |

AUROC by condition: in_distribution=0.496
...
- Protocol: v0.1; config hash `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`; bundle hash `f7b067ec7c6f3b3574d27dc7722e1fec86c4980773b39b83fe0f847b06b3f6cc`
- Re-run: `sieve audit --bundle runs/bundle.qwen15b-anchor.L20.mean_diff.json --seed 0`
