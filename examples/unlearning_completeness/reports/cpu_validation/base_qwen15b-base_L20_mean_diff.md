...
> **Verdict: surface_confounded** (protocol v0.1, config `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`, bundle `3a41ff9184240c59b7e097e912365a92c397e987f776807f5f16297514631cbe`)
>
...
- Probe AUROC: **0.579 [0.534, 0.623]** (leave-one-family-out, n=600, 7 families)
- Surface baseline `length`: AUROC 0.507; probe − baseline = 0.072 [0.007, 0.137]
- Surface baseline `tfidf`: AUROC 0.559; probe − baseline = 0.020 [-0.045, 0.081]
...
- In-distribution, at a 5% false-alarm rate this probe flags about 10% of the cases it should (95% CI 6%–16%).
...
| --- | --- | --- |
| in_distribution | 1% | 3% [0%, 7%] |
| in_distribution | 5% | 10% [6%, 16%] |
| in_distribution | 10% | 16% [12%, 23%] |

AUROC by condition: in_distribution=0.579
...
- Protocol: v0.1; config hash `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`; bundle hash `3a41ff9184240c59b7e097e912365a92c397e987f776807f5f16297514631cbe`
- Re-run: `sieve audit --bundle runs/bundle.qwen15b-base.L20.mean_diff.json --seed 0`
