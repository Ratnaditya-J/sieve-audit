...
> **Verdict: not_decodable** (protocol v0.1, config `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`, bundle `a3e20ea752aa4f3512f6fc2a16100f24205af6cf079aecadc27d4ee4c6e39d22`)
>
...
- Probe AUROC: **0.554 [0.509, 0.603]** (leave-one-family-out, n=600, 7 families)
- Surface baseline `length`: AUROC 0.507; probe − baseline = 0.047 [-0.017, 0.111]
- Surface baseline `tfidf`: AUROC 0.559; probe − baseline = -0.005 [-0.067, 0.055]
...
- In-distribution, at a 5% false-alarm rate this probe flags about 7% of the cases it should (95% CI 4%–13%).
...
| --- | --- | --- |
| in_distribution | 1% | 5% [0%, 7%] |
| in_distribution | 5% | 7% [4%, 13%] |
| in_distribution | 10% | 14% [9%, 20%] |

AUROC by condition: in_distribution=0.554
...
- Protocol: v0.1; config hash `69606752f985ef0ec8d94e2ba9f4970696c15d134875b4d83da9a9315ad4e085`; bundle hash `a3e20ea752aa4f3512f6fc2a16100f24205af6cf079aecadc27d4ee4c6e39d22`
- Re-run: `sieve audit --bundle runs/bundle.qwen15b-base.L20.logistic_regression.json --seed 0`
